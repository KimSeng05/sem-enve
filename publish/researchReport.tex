...
\section{Control Systems Introduction}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{2_feedbackSystems}
    \end{figure}
...
\subsection{BLDC Motor Sensor Control}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{HallEffect.jpg}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{bldcHallSensors.jpeg}
